<template>
  ...
  <a-form-item label="Article Views Pool" help="update article views pool capacity">
    <a-input-number class="w-64" v-model="data.article_views_pool" />
  </a-form-item>

  <a-form-item label="Fast Offset" help="fast offset min page">
